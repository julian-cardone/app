...
| Web component styling conventions                             | `docs/standards/web-css.md`             |
| Web flex layout, overflow, and scroll ownership               | `docs/standards/web-layout.md`          |
| Component architecture, state ownership, abstraction rules    | `docs/standards/frontend-philosophy.md` |
| Folder structure, module boundaries, public surfaces          | `docs/standards/project-structure.md`   |
